...
class SettingsOption extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      notification_min_radius: this.props.settings.notification_min_radius,
      ...
      <View style={styles.container}>
                ...
                <TouchableOpacity
                  ...
                  <Right>
                    <View style={styles.rightSection}>
                      <Icon size={18} name="chevron-right" color="#005b4f" />
                    </View>
                  </Right>
                </TouchableOpacity>
              </Body>
              ...
              <Left>
                <Button disabled style={{backgroundColor: '#FF9501'}}>
                  {this.state.enable_notifications ? (
                    <Icon size={19} name="bell-o" color="white" />
                  ) : (
                    <Icon size={19} name="bell-slash-o" color="white" />
                  )}
                </Button>
              </Left>
              <Body>
              ...
              <Body>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    this.setState({
                      showSlider: {
                        emergency_radius: !this.state.showSlider
                          .emergency_radius,
                      },
                    })
                  }>
              ...
              <Body>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    this.setState({
                      showSlider: {
                        notification_min_radius: !this.state.showSlider
            ...
            <ListItem icon style={styles.listItem} noBorder>
              <Left>
                <Button disabled style={{backgroundColor: 'black'}}>
                  <Icon size={19} name="clock-o" color="white" />
                </Button>
              </Left>
              <Body>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    this.setState({
                      showSlider: {
                        notification_timeout: !this.state.showSlider
        ...
        <Footer>
          <FooterTab style={styles.footer}>
            <Body>
              <Text>All changes you make get saved automatically!</Text>
            </Body>
          </FooterTab>
        </Footer>
      </View>
